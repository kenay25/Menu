...
var MENU = {
  ...
  /* ── COMBOS (de $650 a $120) ──────────────── */
  combos: [
    { id:'c7', emoji:'&#x1F371;', name:'La Caja',       price:650, tag:'new',     hasSauce:true, hasSauce2:true,
    ...
    { id:'c6', emoji:'&#x1F371;', name:'La Cajita',      price:400, tag:null,     hasSauce:true,
    ...
    { id:'c4', emoji:'&#x1F371;', name:'Charola',        price:220, tag:'popular', hasSauce:true,
    ...
    { id:'c3', emoji:'&#x1F371;', name:'Paquetellenes',  price:150, tag:null,     hasSauce:true,
    ...
    { id:'c2', emoji:'&#x1F371;', name:'Botix',          price:120, tag:null,     hasSauce:true,
  ...
  /* ── SUSHIS (de $220 a $80) ───────────────── */
  sushis: [
    { id:'s22', emoji:'&#x1F363;', name:'Borbon',        price:220, tag:'popular', hasSauce:true, hasAlga:true,
    ...
    { id:'s17', emoji:'&#x1F363;', name:'Monster',       price:165, tag:'hot',    hasAlga:true,
      desc:'Por dentro: surimi empanizado, pollo, res, tocino y camarón. Por fuera: queso gratinado con chile serrano.',
      ingredients:[ing('b1','&#x1F359;','Philadelphia','Base',true),ing('b2','&#x1F952;','Pepino','Base',true),ing('b3','&#x1F951;','Aguacate','Base',true),ing('b5','&#x1F980;','Surimi empanizado','Relleno',true),ing('b6','&#x1F357;','Pollo','Relleno',true),ing('b7','&#x1F969;','Res','Relleno',true),ing('b8','&#x1F953;','Tocino','Relleno',true),ing('b9','&#x1F990;','Camarón','Relleno',true),ing('b10','&#x1F9C0;','Queso gratinado','Cubierta',false),ing('b11','&#x1F336;&#xFE0F;','Chile serrano','Cubierta',true)], extras:[] },

    { id:'s18', emoji:'&#x1F363;', name:'Franco Roll',   price:165, tag:'new',    hasAlga:true,
    ...
    { id:'s19', emoji:'&#x1F363;', name:'La Chuyita',    price:165, tag:'popular', hasAlga:true,
    ...
    { id:'s21', emoji:'&#x1F363;', name:'Mexicano 2',    price:165, tag:null,     hasAlga:true,
    ...
    { id:'s_mayito', emoji:'&#x1F371;', name:'Mayito',   price:145, tag:'popular', hasProtein:true, hasSauce:true,
    ...
    { id:'s13', emoji:'&#x1F363;', name:'Mix Roll',      price:145, tag:null,     hasProtein:true, hasAlga:true,
    ...
    { id:'s14', emoji:'&#x1F363;', name:'Baked',         price:145, tag:'hot',    hasAlga:true,
    ...
    { id:'s15', emoji:'&#x1F363;', name:'Fernanda',      price:145, tag:null,     hasAlga:true,
    ...
    { id:'s16', emoji:'&#x1F363;', name:'Hot',           price:145, tag:'hot',    hasAlga:true,
    ...
    { id:'s20', emoji:'&#x1F363;', name:'Mexicano 1',    price:145, tag:null,     hasAlga:true,
    ...
    { id:'s5',  emoji:'&#x1F363;', name:'Tres Quesos',   price:135, tag:null,     hasProtein:true, hasAlga:true,
    ...
    { id:'s11', emoji:'&#x1F363;', name:'Chipotle',      price:135, tag:null,     hasAlga:true,
    ...
    { id:'s12', emoji:'&#x1F363;', name:'Queen Roll',    price:135, tag:'popular', hasAlga:true,
    ...
    { id:'s9',  emoji:'&#x1F363;', name:'Cielo Mar y Tierra', price:120, tag:null, hasAlga:true,
    ...
    { id:'s10', emoji:'&#x1F363;', name:'Antojo',        price:120, tag:null,     hasAlga:true,
    ...
    { id:'s2',  emoji:'&#x1F363;', name:'Bombazo',       price:110, tag:'popular', hasProtein:true, hasAlga:true,
    ...
    { id:'s3',  emoji:'&#x1F363;', name:'Sonora',        price:110, tag:null,     hasAlga:true,
    ...
    { id:'s8',  emoji:'&#x1F363;', name:'Daishi',        price:100, tag:null,     hasAlga:true,
    ...
    { id:'s6',  emoji:'&#x1F363;', name:'Aguacate',      price:100, tag:null,     hasProtein:true, hasAlga:true,
    ...
    { id:'s1',  emoji:'&#x1F363;', name:'California',    price:95,  tag:null,     hasProtein:true, hasAlga:true,
    ...
    { id:'s4',  emoji:'&#x1F363;', name:'Especial',      price:115, tag:'popular', hasAlga:true,
    ...
    { id:'s7',  emoji:'&#x1F363;', name:'Misil',         price:80,  tag:null,     hasAlga:false,
  ...
  entradas: [
    { id:'en1', emoji:'&#x1F9C6;', name:'Tostiboneles',  price:150, tag:null,     hasSauce:true,
    ...
    { id:'en7', emoji:'&#x1F35F;', name:'Papiboneles',   price:130, tag:'new',    hasSauce:true,
    ...
    { id:'en6', emoji:'&#x26AB;',  name:'Boliblitz',     price:100, tag:'popular',
    ...
    { id:'en2', emoji:'&#x1F32E;', name:'Tostitampico',  price:70,  tag:null,
    ...
    { id:'en3', emoji:'&#x1F9C0;', name:'Dedos de Queso',price:60,  tag:'popular',
    ...
    { id:'en4', emoji:'&#x1F35F;', name:'Papas Sazonadas',price:50, tag:null,
    ...
    { id:'en5', emoji:'&#x1F336;&#xFE0F;', name:'Chile Caribe Relleno', price:30, tag:null,
  ...
  especiales: [
    { id:'esp4', emoji:'&#x1F35A;', name:'Yakimeshi',    price:135, tag:null,
    ...
    { id:'esp5', emoji:'&#x1F35A;', name:'Gohan',        price:135, tag:'popular',
    ...
    { id:'esp1', emoji:'&#x1F357;', name:'Alitas',       price:120, tag:'popular', hasSauce:true,
      desc:'Picositas o salsa a elección.',
      ingredients:[ing('b1','&#x1F357;','Alitas de pollo','Orden',false)], extras:[] },

    { id:'esp2', emoji:'&#x1F357;', name:'Boneless',     price:120, tag:'popular', hasSauce:true,
    ...
    { id:'esp3', emoji:'&#x1F357;', name:'Boneless con Papas', price:120, tag:null, hasSauce:true,
    ...
    { id:'esp8', emoji:'&#x1F363;', name:'Bolas — Mixta', price:95, tag:null,     hasProtein:true,
    ...
    { id:'esp7', emoji:'&#x1F363;', name:'Bolas — Camarón', price:85, tag:null,
    ...
    { id:'esp6', emoji:'&#x1F363;', name:'Bolas — Básica', price:75, tag:null,    hasProtein:true,
      desc:'01 proteína a elegir: res, camarón, tocino, pollo o surimi.',
...
/* ── PROMOCIONES ────────────────────────────── */
var PROMOS = [
  { id:'promo4', emoji:'&#x1F371;', num:'Paquete 4', title:'1 Boneless + 1 California', price:150, tag:'popular', hasProtein:true, hasSauce:true,
  ...
  { id:'promo1', emoji:'&#x1F363;', num:'Paquete 1', title:'2 Californias + Tostitampico', price:220, tag:'popular', hasProtein:true,
  ...
  { id:'promo2', emoji:'&#x1F363;', num:'Paquete 2', title:'2 Sonoras', price:200, tag:null,
    desc:'2 Sonoras (res, tocino, philadelphia y chile rescoldado).',
    ingredients:[ing('b1','&#x1F363;','2 Sonoras','Incluidas',false)], extras:[] },

  { id:'promo3', emoji:'&#x1F363;', num:'Paquete 3', title:'3 Bolas', price:200, tag:null, hasProtein:true,
